# Get purchase and coupon links for one product · Public API v2
...
Get purchase and coupon links for one product
...
| 参数 | 位置 | 必填 | 类型 | 说明 |
| --- | --- | --- | --- | --- |
| `product_id` | path | 是 | string | DLsite product number. RJ is doujin, VJ is commercial. |
...
---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/v2/getStorePurchaseLinks
