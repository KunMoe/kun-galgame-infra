# List every top-level error code · Public API v2（preview）
...
The closed registry of top-level error codes. Keyset-paginated. Unauthenticated.
...
---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/v2/listProblemTypes
