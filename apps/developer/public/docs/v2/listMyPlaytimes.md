# List my playtimes · Public API v2（preview）
...
```bash
curl "https://api.nextmoe.dev/v2/me/playtimes" \
  -H "Authorization: Bearer <ACCESS_TOKEN>"
```

---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/v2/listMyPlaytimes
