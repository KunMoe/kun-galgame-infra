# List published vocabularies · Public API v2（preview）
...
List published vocabularies

Closed and seed-open vocabularies. Keyset-paginated. Unauthenticated.
...
---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/v2/listVocabularies
