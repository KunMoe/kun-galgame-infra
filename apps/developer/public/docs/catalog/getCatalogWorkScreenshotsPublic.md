# Screenshots of one work, paged, with dimensions and thumbhash · 目录数据 API（只读）
...
Screenshots of one work, paged, with dimensions and thumbhash
...
```bash
curl "https://api.nextmoe.dev/v1/catalog/works/1/screenshots" \
  -H "Authorization: Bearer nmk_live_<YOUR_KEY>"
```

---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/catalog/getCatalogWorkScreenshotsPublic
