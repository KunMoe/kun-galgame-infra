# Non-identity outbound links of one work (official site, Steam, X, …), paged · 目录数据 API（只读）
...
Non-identity outbound links of one work (official site, Steam, X, …), paged
...
```bash
curl "https://api.nextmoe.dev/v1/catalog/works/1/links" \
  -H "Authorization: Bearer nm_live_<YOUR_KEY>"
```

---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/catalog/getCatalogWorkLinksPublic
