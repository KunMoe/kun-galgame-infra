# Release calendar, the global announced-but-undated bucket (id ASC keyset) · 目录数据 API（只读）
...
Release calendar, the global announced-but-undated bucket (id ASC keyset)
...
---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/catalog/listCatalogCalendarTBAPublic
