# The character roster of one work, paged, with voice credits · 目录数据 API（只读）
...
The character roster of one work, paged, with voice credits
...
```bash
curl "https://api.nextmoe.dev/v1/catalog/works/1/characters" \
  -H "Authorization: Bearer nm_live_<YOUR_KEY>"
```

---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/catalog/getCatalogWorkCharactersPublic
