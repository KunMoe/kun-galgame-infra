# The series this work belongs to, paged · 目录数据 API（只读）
...
The series this work belongs to, paged
...
```bash
curl "https://api.nextmoe.dev/v1/catalog/works/1/series" \
  -H "Authorization: Bearer nmk_live_<YOUR_KEY>"
```

---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/catalog/getCatalogWorkSeriesPublic
