# Per-source ratings of one work, paged, with the vote histogram and the spread · 目录数据 API（只读）
...
Per-source ratings of one work, paged, with the vote histogram and the spread
...
```bash
curl "https://api.nextmoe.dev/v1/catalog/works/1/ratings" \
  -H "Authorization: Bearer nmk_live_<YOUR_KEY>"
```

---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/catalog/getCatalogWorkRatingsPublic
