# Batch old id → canonical id (redirect flattening) for a given entity_type · 目录数据 API（只读）
...
---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/catalog/resolveCatalogPublic
