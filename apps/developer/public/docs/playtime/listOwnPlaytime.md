...
| 参数 | 位置 | 必填 | 类型 | 说明 |
| --- | --- | --- | --- | --- |
| `updated_since` | query | 否 | string | RFC 3339 timestamp; returns only rows changed AFTER it. Omit for a full first pull |
| `limit` | query | 否 | integer (int64) | Page size |

```bash
curl "https://api.nextmoe.dev/v1/playtime/mine" \
  -H "Authorization: Bearer <ACCESS_TOKEN>"
```

---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/playtime/listOwnPlaytime
