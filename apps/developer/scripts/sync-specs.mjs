 ...
 * registry gets the same treatment through i18n/problems-zh.json, except that
 * its English source is Go-generated rather than derived here.
 *
...
const llmFiles = writeLlmArtifacts(model, guides.pages, problems, PUBLIC_DIR)
console.log(
