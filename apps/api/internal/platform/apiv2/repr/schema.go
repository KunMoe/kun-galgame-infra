...
type SchemaField struct {
	...
	Vocabulary    string         `json:"vocabulary" maxLength:"64" doc:"Names the /v2/vocabularies vocabulary whose tokens this field accepts. Empty when the field has none. On an integer-coded field the tokens are labels and the wire carries the token's 0-based index in the vocabulary's published order."`
...
type SchemaElementMember struct {
	...
	Vocabulary string   `json:"vocabulary" maxLength:"64" doc:"Names the /v2/vocabularies vocabulary whose tokens this member accepts. Empty when the member has none. On an int member the tokens are labels and the wire carries the token's 0-based index in the vocabulary's published order."`
